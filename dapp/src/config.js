var txDefaultOrig = {
  ...
  // ethereumNode: "https://public-node-api.klaytnapi.com/v1/baobab",
  ...
  defaultChainID: 8217,
  // Mainnet
  // walletFactoryAddress: "0x3d59d480e4a3DFCa5b33b01c7cc4e8d097A92d08",
...
function checkWalletFactoryAddress() {
  ...
  if (
    userConfig &&
    oldWalletFactoryAddresses.indexOf(
      userConfig.walletFactoryAddress.toLowerCase()
    ) >= 0
  ) {
